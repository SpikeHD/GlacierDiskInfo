use libglacierdisk::{
  benchmark::{
    read_sequential::ReadSequentialBenchmark, write_sequential::WriteSequentialBenchmark,
...
fn main() {
  ...
  // Write benchmark
  let mut write_benchmark = WriteSequentialBenchmark::new(
    disk.clone(),
    0,
    BenchmarkConfig {
  ...
  // Read benchmark
  let mut read_benchmark = ReadSequentialBenchmark::new(
    disk,
    0,
    BenchmarkConfig {
