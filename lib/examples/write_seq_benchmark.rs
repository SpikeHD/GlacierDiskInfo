use libglacierdisk::{
  benchmark::{write_sequential::WriteSequentialBenchmark, Benchmark, BlockConfig},
  disk::Disk,
};
...
fn main() {
  ...
  let mut benchmark = WriteSequentialBenchmark::new(disk, 0, BlockConfig::default()).unwrap();
