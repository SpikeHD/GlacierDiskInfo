use libglacierdisk::{
  benchmark::{read_sequential::ReadSequentialBenchmark, Benchmark, BenchmarkConfig},
  disk::Disk,
};
...
fn main() {
  ...
  let mut benchmark = ReadSequentialBenchmark::new(disk, 0, BenchmarkConfig::default()).unwrap();
